...
/**
 * AccountSettingsController controls the AccountSettingsFrame, managing operations like gathering the data
 * for display, changing the data and updating the display.
 */
public class AccountSettingsController extends UserFrameController {
   ...
   * It asks the user to introduce its current password before changing it.
