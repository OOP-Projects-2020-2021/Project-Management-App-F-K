...
public class ChangePasswordController extends UserFrameController {
    ...
    /**
     * Attempts to change the password introduced by the user.
     * The password is updated only when the two passwords are equal, in which case
     * a message window will pop up and inform the user that the password was changed.
