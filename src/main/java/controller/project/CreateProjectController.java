...
public class CreateProjectController extends FrameController {
    ...
    public int getIdOfTeam(String teamName) {
        ...
        try {
            ...
            ErrorDialogFactory.createErrorDialog(e,frame,"No team with name \""+teamName +"\" exists.");
        }
        return -1;
    }

    /**
     * Creates a project with the data introduced by the user.
     * It displays a confirmation message if all the data was successfully saved and closes the frame.
    ...
    private void displaySavedMessageDialog() {
        JOptionPane.showMessageDialog(frame,PROJECT_SAVED_MESSAGE,PROJECT_SAVED_TITLE,JOptionPane.INFORMATION_MESSAGE);
    }
