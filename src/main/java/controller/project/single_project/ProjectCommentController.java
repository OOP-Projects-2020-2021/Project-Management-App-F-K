...
public class ProjectCommentController implements PropertyChangeListener {
  ...
  public void addComment(String text) {
    ...
    } catch (NoSignedInUserException | InexistentProjectException | SQLException | InexistentDatabaseEntityException | InexistentTeamException e) {
      ErrorDialogFactory.createErrorDialog(e,null,null);
    } catch (UnauthorisedOperationException e) {
      ErrorDialogFactory.createErrorDialog(e,null,"You cannot add a comment, because you are not a member of the team.");
    }
  }
