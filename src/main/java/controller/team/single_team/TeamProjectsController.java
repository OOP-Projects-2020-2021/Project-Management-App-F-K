...
/**
 * This controller manages the TeamProjectsPanel, and it is responsible for displaying and filtering the list of projects.
 *
...
public class TeamProjectsController extends TeamController implements PropertyChangeListener {
    ...
    public List<Project> getAllProjects() {
        ...
        for(int i=0;i<10;i++) {
            projects.add(new Project(1,"Project"+i,52,LocalDate.now(), Project.ProjectStatus.TO_DO,2,12));
        }
        return projects;
    }
