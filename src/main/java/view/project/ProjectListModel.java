 ...
 * It is implemented using the singleton pattern, so that when the data in the model changes, all of
 * its instances would be updated. When a user applies a filter on the projects list in the
