...
/**
 * ProjectsPanel displays the list of projects, which can be sorted based on the deadline or filtered based on the
 * project's status, turn-in time, assignee or supervisor.
 * The user can visit a specific project if he/she double clicks on the title of the project.
 *
